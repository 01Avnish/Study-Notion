...
const onSubmit = async (data) => {
  ...
  // console.log("New Subsection from backend:", response?.newSubSection);

if (response && response.newSubSection) {
  const updatedCourseContent = course.courseContent.map((section) => {
    if (section._id === modalData) {
      return {
        ...section,
        subSection: [...section.subSection, response.newSubSection],
      };
    }
    return section;
  });
